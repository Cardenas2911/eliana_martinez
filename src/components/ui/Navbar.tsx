    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex items-center justify-between">
          <a 
            href="#hero" 
            className="relative z-[70] font-heading text-2xl md:text-[1.7rem] font-medium text-brown-dark tracking-wide no-underline hover:opacity-80 transition-opacity"
          >
            Eliana Martínez
          </a>
          ...
          <div className="flex items-center gap-5">
            <a 
              href="https://wa.me/573118909491?text=Hola+Eliana+🤍+Estaba+viendo+tu+web+y+me+gustaría+saber+más+sobre+tu+trabajo" 
              target="_blank"
